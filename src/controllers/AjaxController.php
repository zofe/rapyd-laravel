...
class DemoController extends \BaseController {
    ...
    public function getSet()
    {
        ...
        return  View::make('demo.set', compact('set'));
    }
    ...
    public function getGrid()
    {
        ...
        $grid->add('{{ $row->author->firstname }}','Author', 'title');
        $grid->add('body','Body');
        $grid->edit('/demo/edit', 'Edit','show|modify');
        $grid->paginate(10);
    ...
    public function getFilter()
    {
        ...
        $grid->add('body','Body');
        $grid->edit('/demo/edit', 'Edit','modify');
        $grid->paginate(10);
    ...
    public function anyForm()
    {
        ...
        $form->saved(function() use ($form)
        {
            ...
            $form->link("/demo/form","back to the form");
        });
    ...
    public function anyEdit()
    {
        ...
        $edit->link("demo/filter","Articles", "TR");
